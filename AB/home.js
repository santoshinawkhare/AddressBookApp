...
const createInnerHtml = () => {
    ...
    <tr>
        ...
        <td>
            <img id="${addressBook.id}" onclick="remove(this)" alt="delete" src="./img/delete-black-18dp.svg">
            <img id="${addressBook.id}" alt="edit" onclick="update(this)" src="./img/create-black-18dp.svg">
        </td>
    </tr>
    `;
